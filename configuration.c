      ...
      settings_t *settings, int *size)
{
   ...
   SETTING_BOOL("audio_enable_musica_no_menu_option",         &settings->bools.audio_enable_musica_no_menu_option, true, DEFAULT_AUDIO_ENABLE_MUSICA_NO_MENU_OPTION, false);
